...
char bufferemon[1000], cont[1000], type[1000], messages[100000] , token[];
void reg(void);
void lin(void);
void menu2(void);
void createch(void);
...
void reza(int x)
{
    ...
    createch()
    {
        ...
        strcat(type, cJSON_GetObjectItem(response, "type") -> valuestring);
        strcat(cont, cJSON_GetObjectItem(response, "content") -> valuestring);
